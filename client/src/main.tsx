...
document.documentElement.style.setProperty('--primary', '59 130 246'); // Blue
document.documentElement.style.setProperty('--primary-light', '96 165 250');
...
document.documentElement.style.setProperty('--accent', '59 130 246'); // Blue
